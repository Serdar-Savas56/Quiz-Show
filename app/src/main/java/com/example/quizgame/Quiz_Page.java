    ...
    public void game()
    {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(Quiz_Page.this,"Tüm Sorular Cevaplanmıştır", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(DatabaseError error) {
                ...
                Toast.makeText(Quiz_Page.this,"Üzgünüm,Bir problem oluştu!", Toast.LENGTH_SHORT).show();
        ...
        databaseReferenceSecond.child("scores").child(userID).child("correct").setValue(userCorrect)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Quiz_Page.this, "Skor Başarıyla Göderildi",Toast.LENGTH_SHORT).show();
                    }
                });
